...
public class PizzaPOS {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("The cost of your order is: " + MONEY_FORMAT.format(cost));

        // calculate and display tax and total cost
        tax = cost * TAX_RATE;
        System.out.println("The tax is: " + MONEY_FORMAT.format(tax));
        System.out.println("The total due is: " + MONEY_FORMAT.format(tax + cost));
